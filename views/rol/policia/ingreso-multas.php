            ...
            <form class="row" action="resultado-multas" method="POST">
                ...
                <div class="col-md-4 mt-4">
                    ...
                    <input type="text" class="form-control" name="color"
                     oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" 
                     style="text-transform:uppercase" maxlength="50" title="Ingrese el color del vehículo" placeholder="Gris" required>
                </div>
                <div class="col-md-8 mt-4">
                    ...
                    style="text-transform:uppercase" maxlength="50" title="Ingrese el color del vehículo" placeholder="san vicente pacaya" required>
                </div>
                <div class="col-md-4 mt-4">
                    ...
                    title="Más información sobre las multas">
                ...
                <div class="col-md-4 mt-4">
                    <label for="inputE4" class="form-label">Monto por Infracción</label>
                ...
                <div class="col-md-4 mt-4">
                    <label for="inputE4" class="form-label">Descuento (Si paga en 5 dias hábiles)</label>
