...
<head>
    ...
    <title>Exoneración | Municipalidad de San Vicente Pacaya</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width: 90%;">
                    ...
                    <!-- Page Heading -->
                    <div class="mt-5 mb-5">
                        <h1 class="h1-estilo text-gray-800">Exonerar Multas</h1>
                        <p class="p-estilo">Puedes visualizar las multas a exonerar, y puedes buscar por placas y fechas.</p>
                    </div>
                    ...
                    <a href="exonerar-multas" class="btn btn-secondary mt-2">
                    ...
                    if (isset($_GET["buscarXPlaca"])) {
                        include("../../../../business/admin/reportes/exonerarPagar/filter-p.php");
                    }
                    if (isset($_GET["buscarXFechas"])) {
                        include("../../../../business/admin/reportes/exonerarPagar/filter-date.php");
                    }
