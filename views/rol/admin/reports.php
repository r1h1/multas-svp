        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid w-75">
                    ...
                    <!-- Page Heading -->
                    <div class="mb-4 mt-5">
                        <h1 class="h3 text-gray-800">Reportes</h1>
                    </div>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4 border-left-danger">
                                <a href="rpts/multas-pendientes-pago" class="nav-link">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">MULTAS PENDIENTES DE PAGO</h6>
                                    </div>
                            ...
                            <div class="card shadow mb-4 border-left-dark">
                                <a href="rpts/exonerar-multas" class="nav-link">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">EXONERAR / PAGAR MULTAS</h6>
                                    </div>
                                    <div class="card-body text-center">
                                        <i class="fa-solid fa-car" style="font-size: 90px; color: #858796;"></i>
