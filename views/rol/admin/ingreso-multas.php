                    ...
                    <section class="mt-4 container-sm w-100 mb-5">
                        <form class="row" action="" method="POST">
                            ...
                            <div class="col-md-4 mt-4">
                                ...
                                <input type="text" class="form-control" name="color" style="text-transform:uppercase"
                                placeholder="gris" required>
                            </div>
                            ...
                            <div class="col-md-4 mt-4">
                                <label for="inputP4" class="form-label">Monto por Infracción</label>
                                <input type="text" class="form-control" name="montoInfraccion" placeholder="0.00" readonly required>
                            </div>
                            <div class="col-md-4 mt-4">
